...
- You have access to long-term memory from past conversations. Use query_long_term_memory to search for relevant context from previous sessions when the user references past discussions or when historical context would help. Use retrieve_long_term_memory for direct topic retrieval.
